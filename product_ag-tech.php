...
<html lang="ru">
  ...
  <body>
    ...
    <section class="section bg-grey ag-tech">
      <div class="photo photo-ag">
      ...
      <div class="container accessory">
        ...
        <h1 class="section-title other-title ag-title">
          Автохимия AG-Tech
        </h1>
        <ul class="breadcrumb">
          <li class="breadcrumb-item"><a href="/index.php">Главная</a></li>
          <li class="breadcrumb-item"><a href="/contract.php">Собственные торговые марки</a></li>
          <li class="breadcrumb-item">Автохимия AG-Tech</li>
        </ul>
      </div>
    </section>
<section class="section about">
  <picture>
    <source type="image/webp" srcset="img/him_ag_tech.webp">
    <source type="image/jpeg" srcset="img/him_ag_tech.png">
    <img src="img/him_ag_tech.png" alt="" class="him-photo ag-photo">
  </picture>
    <div class="container">
      <div class="him-content-wrapper ag-wrapper">
        <div class="ag-content">
          ...
          <p class="him-text ag-text ag-text-second">
...
<section class="section bg-grey">
  <div class="container wrapper">
    <div class="general-wrapper">
      <div class="seporator"></div>
      <h2 class="general-title">Генеральный дистрибьютор премиальной автохимии</h2>
      ...
      <ul class="our-production-list ag-list">
        <li class="our-production-item ag-item">
        ...
        <li class="our-production-item ag-item">
          <svg height="23" width="23" class="clients-list-icon">
      ...
      <button class="button button-ag">
        <svg height="20" width="20" class="clients-list-icon">
    ...
    <picture>
      <source type="image/webp" srcset="img/header_book.webp">
      <source type="image/jpeg" srcset="img/header_book.png">
      <img src="img/header_book.png" alt="" class="general-photo">
    </picture>
  </div>
</section>
<?php $styleText = 'ag-him-text';
  $styleList = 'ag-him-list';
  $styleBlogSlider = '';
  $styleButton = 'ag-button';
