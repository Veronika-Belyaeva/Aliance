...
$header_style = 'bg-photo';
$styleTitle = 'now-title';
$breadcrumb_title = "Блог";
$breadcrumb_li = "/blog.php";
    ...
    <div class="modern-wrapper">
      ...
      <div class="block-wrapper">
        <div class="plan-block">
          <h2 class="title-plan">Реализация намеченных плановых заданий</h2>
          <p class="plan-text">
        ...
        <div class="consultation-block">
          ...
          <p class="consultation-text second-consultation">
          ...
          <p class="consultation-text second-consultation">
            Разнообразный и богатый опыт начало повседневной работы по формированию позиции позволяет оценить значение позиций, занимаемых участниками в отношении поставленных задач. Разнообразный и богатый опыт реализация намеченных плановых заданий позволяет выполнять важные задания по разработке форм развития. Задача организации, в особенности же постоянный <span class="height-kol">количественный рост</span> и сфера нашей активности обеспечивает широкому кругу (специалистов) участие в формировании форм развития.
          </p>
          <picture>
            <source type="image/webp" srcset="img/blog/blog-photo.webp">
            <source type="image/jpeg" srcset="img/blog/blog-photo.jpg">
            <img src="img/blog/blog-photo.jpg" alt="consultation" class="consultation-photo">
          </picture> 
