    ...
    <div class="container">
      <div class="footer-wrapper">
        ...
        <div class="footer-author">
          ...
          <svg class="footer-social-icon" height="11" width="40">
